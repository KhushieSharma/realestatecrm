  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div>
          <img className="mx-auto h-12 w-auto" src="/logo.png" alt="EstateFlow CRM" />
          <h2 className="mt-6 text-center text-3xl font-bold text-gray-900">
            Sign in to EstateFlow CRM
          </h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="relative">
            ...
            >
              {loading ? (
                <>
                  <span className="mr-2 h-5 w-5 animate-spin border-2 border-white border-t-transparent rounded-full"></span>
                  Signing in...
                </>
              ) : (
                'Sign in'
